...
function ProductSpecial() {
  const [banner, setBanner] = useState({
    title: "",
    imageUrl: "",
    code: "special", // Mặc định là slide
  });
  ...
  const handleSubmit = async (e) => {
    ...
    if (banners.slide.length > 0) {
        alert("Đã có ảnh đặc biệt! Không thể tải ảnh mới.");
        return;
      }
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4 text-gray-700">Quản lý sản phẩm đặc biệt</h1>
