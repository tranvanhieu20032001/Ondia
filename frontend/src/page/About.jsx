...
import { CiBag1, CiFacebook, CiGift, CiInstagram, CiShop, CiTwitter } from "react-icons/ci";
...
function About() {
  const descriptions = [
    ...
    { number: "FREE AND FAST DELIVERY", des: "Free delivery for all orders over $140", icon: <FaShippingFast /> },
    { number: "24/7 CUSTOMER SERVICE", des: "Friendly 24/7 customer support", icon: <MdOutlineHeadsetMic /> },
    { number: "MONEY BACK GUARANTEE", des: "We reurn money within 30 days", icon: <AiOutlineFileProtect /> },
  ];
  return (
    <div className="max-w-screen-xl lg:mx-auto my-16 mx-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
        <div className="space-y-8">
          <h2 className="capitalize text-2xl font-semibold lg:text-5xl">Our Story</h2>
      ...
      <div className="grid grid-cols-4 gap-2 lg:gap-8 my-16">
        {descriptions.map((des, index) => index<4&&(
          <div
            key={index}
      ...
      <div className="grid grid-cols-3 gap-3 lg:ap-8">
        <div className="w-full h-auto space-y-3">
          <img className="w-full max-w-[370px] object-cover max-h-[420px] h-auto" src="https://studiochupanhdep.com/Upload/Images/Album/anh-cv-02.jpg" alt="" />
          <h2 className="capitalize text-sm lg:text-3xl font-semibold">Tom cruise</h2>
          <span className="text-[12px] lg:text-base">Founder & Chairman</span>
          <p className="flex gap-4 items-center"><CiTwitter size={25} /><CiInstagram size={25}/><CiFacebook size={25}/></p>
        </div>
        <div className="w-full h-auto space-y-3">
          <img className="w-full max-w-[370px] object-cover max-h-[420px] h-auto" src="https://hthaostudio.com/wp-content/uploads/2021/12/Anh-avatar-linkedin-dep-4.jpg" alt="" />
          <h2 className="capitalize text-sm lg:text-3xl font-semibold">emma wation</h2>
          <span className="text-[12px] lg:text-base">Managing Director</span>
          <p className="flex gap-4 items-center"><CiTwitter size={25} /><CiInstagram size={25}/><CiFacebook size={25}/></p>
        </div>
        <div className="w-full h-auto space-y-3">
          <img className="w-full max-w-[370px] object-cover max-h-[420px] h-auto" src="https://studiochupanhdep.com/Upload/Images/Album/anh-cv-02.jpg" alt="" />
          <h2 className="capitalize text-sm lg:text-3xl font-semibold">Will Smith</h2>
