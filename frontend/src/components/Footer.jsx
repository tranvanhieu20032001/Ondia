...
function Footer() {
  return (
   <div className="w-full bg-black">
     <div className="max-w-screen-xl bg-transparent px-4 mx-auto py-12 grid grid-cols-2 lg:grid-cols-5 gap-5 text-white">
      <div className="">
        <img src={logo} alt="" className="h-10 lg:h-16 w-auto" />
        <h1 className="text-[16px] lg:text-lg my-2">Subscribe</h1>
        <span className="my-2 inline-block text-[12px] lg:[text-16px]">Get 10% off your first order</span>
        <div className="flex w-[217px] border-2 items-center rounded-md">
          <input
            type="search"
          ...
          <div className="flex items-center p-2 cursor-pointer">
            <IoIosSend className="text-black size-5" />
          </div>
        </div>
      </div>
      <div className="">
        <h1 className="text-[16px] lg:text-lg my-2">Support</h1>
        <ul className="font-normal flex flex-col gap-3">
          <li className="text-[12px] lg:text-[16px]">111 Bijoy sarani, Dhaka, DH 1515, Bangladesh.</li>
          <li className="text-[12px] lg:text-[16px]">exclusive@gmail.com</li>
          <li className="text-[12px] lg:text-[16px]">+88015-88888-9999</li>
        </ul>
      </div>
      <div className="">
        <h1 className="text-[16px] lg:text-lg my-2">Account</h1>
        <ul className="text-[12px] lg:text-[16px] font-normal flex flex-col gap-3">
          <li className="text-[12px] lg:text-[16px]">My Account</li>
          <li className="text-[12px] lg:text-[16px]">Login / Register</li>
          <li className="text-[12px] lg:text-[16px]">Cart</li>
          <li className="text-[12px] lg:text-[16px]">Wishlist</li>
          <li className="text-[12px] lg:text-[16px]">Shop</li>
        </ul>
      </div>
      <div className="">
        <h1 className="text-[16px] lg:text-lg my-2">Quick Link</h1>
        <ul className="text-[12px] lg:text-[16px] font-normal flex flex-col gap-3">
          <li className="text-[12px] lg:text-[16px]">Privacy Policy</li>
          <li className="text-[12px] lg:text-[16px]">Terms Of Use</li>
          <li className="text-[12px] lg:text-[16px]">FAQ</li>
          <li className="text-[12px] lg:text-[16px]">Contact</li>
        </ul>
      </div>
      <div className="">
        <h1 className="text-[16px] lg:text-lg my-2">Download App</h1>
